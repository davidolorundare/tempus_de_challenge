...
- With [FakeS3 installed](#optional-prereqs) already, in the terminal navigate to a directory of your choice and run the following command: `fakes3 -r . -p 4567 --license YOUR_LICENSE_KEY`, replacing 'YOUR_LICENSE_KEY with the key you obtained during the FakeS3 registeration. This command then starts the Fake Amazon S3 server.
