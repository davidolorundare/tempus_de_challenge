...
- Note security concern of hardcoding the News API apikey the functions used for the http requests. 
	...
	* Airflow has an option of storing keys in a [Variable](https://airflow.apache.org/concepts.html#variables) but it based on the Airflow documentation it doesn't seem to be a very secure approach. Might want to look better ways of api key encryption ?
